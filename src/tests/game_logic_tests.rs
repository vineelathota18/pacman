...
mod game_logic_tests {
    ...
    fn test_ghost_collision() {
        ...
        let collision =
            check_ghost_collision_test(&pacman_pos, &ghosts, &mut is_dying, &mut lives, false);
        ...
        let collision =
            check_ghost_collision_test(&pacman_pos, &ghosts, &mut is_dying, &mut lives, true);
    ...
    fn test_movement() {
        ...
        let next_pos = simulate_move(&Direction::Right, &current_pos, &mut maze, &mut score);
